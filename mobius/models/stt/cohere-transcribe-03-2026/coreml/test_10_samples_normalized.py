#!/usr/bin/env python3
"""Test stateful decoder with punctuation-normalized WER."""
...
print("="*70)
print("Cohere Stateful Decoder - 10 Sample Test (Normalized WER)")
print("="*70)
...
for sample_idx, sample in enumerate(samples):
    ...
    print(f"     Normalized WER: {sample_wer:.2f}%")
...
print("\n" + "="*70)
print("RESULTS (Punctuation-Normalized WER)")
print("="*70)
