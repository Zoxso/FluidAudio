#!/usr/bin/env python3
"""Test stateful decoder with punctuation-normalized WER on 100 samples."""
...
print("="*70)
print("Cohere Stateful Decoder - 100 Sample Test (Normalized WER)")
print("="*70)
...
print("\n" + "="*70)
print("RESULTS (100 Samples, Punctuation-Normalized WER)")
print("="*70)
...
print(f"   Documented: 23.76% WER, 64% perfect matches")
print(f"   This run:   {avg_wer:.2f}% WER, {perfect_pct:.1f}% perfect matches")

# Save results to JSON
output_file = "test_100_samples_results.json"
